...
const GlowingEffect = memo(
    ({
        ...
        }, [handleMove, disabled, autoRotate]);

        // Auto-rotate: continuously spin the glow angle when active
        useEffect(() => {
            if (!autoRotate || !glow) {
                // Reset when glow turns off
                ...
                >
                    <div
                        className={cn(
                            ...
                            autoRotate
                                ? "after:mask-[linear-gradient(#0000,#0000),linear-gradient(#fff,#fff)]"
